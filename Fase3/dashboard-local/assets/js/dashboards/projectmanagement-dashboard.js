(function (factory) {
  ...
  const issuesDiscoveredChartInit = () => {
    const { getColor: e, getData: t, toggleColor: i } = window.phoenix.utils,
  ...
  const zeroBurnOutChartInit = () => {
    const { getColor: o, getData: e, getPastDates: t } = window.phoenix.utils,
      r = document.querySelector(".echart-zero-burnout-chart");
    if (r) {
      const i = e(r, "echarts"),
      ...
      echartSetOption(l, i, () => ({
        ...
        xAxis: [
          {
            ...
            splitLine: {
              interval: 0,
              show: !0,
              lineStyle: { color: o("border-color"), type: "dashed" },
            },
            type: "category",
            boundaryGap: !1,
            data: t(15),
        ...
        yAxis: {
          show: !0,
          type: "value",
          axisLine: { lineStyle: { type: "solid", color: o("border-color") } },
          axisLabel: {
            color: o("body-color"),
            margin: 20,
            fontSize: 12.8,
        ...
        series: [
          {
            ...
            lineStyle: { width: 0 },
            areaStyle: { color: o("primary-light"), opacity: 0.075 },
            tooltip: { show: !1 },
          },
          {
            name: "Issues found",
          ...
          },
          {
            ...
            lineStyle: { color: o("quaternary-color"), type: "dashed" },
            symbol: "circle",
  ...
  const zeroRoadmapChartInit = () => {
    ...
    if (e) {
      ...
      gantt.ext.zoom.init(n),
        ...
        (gantt.timeline_cell_class = function (t, e) {
          return "weekend";
        }),
